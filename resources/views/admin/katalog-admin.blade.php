...
<div class="py-10 space-y-10">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 animate-fade-up">
        <div>
            <h1 class="text-4xl font-bold text-gray-800">Manajemen Katalog</h1>
            <p class="text-gray-500 mt-2">Kelola seluruh koleksi buku fisik ReadSpace Library.</p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        ...
        <div class="col-span-full py-20 text-center">
            ...
            <p class="text-gray-400 font-medium">Belum ada buku dalam katalog.</p>
        </div>
        @endforelse
    </div>
