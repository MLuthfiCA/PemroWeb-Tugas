...
<div class="container mx-auto px-6 py-8">
    <div class="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
        <div>
            <h1 class="text-3xl font-extrabold text-[#632024]">Pencarian Data Buku</h1>
            <p class="text-gray-600">Manajemen pencarian koleksi perpustakaan</p>
        </div>
        
        <div class="w-full md:w-96">
            <form action="{{ route('admin.search') }}" method="GET" class="relative">
                <input type="text" name="query" placeholder="Cari ID atau Judul..." 
