...
<head>
    ...
    <title>Dashboard - Readspace Library</title>
...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <a href="#" class="flex items-center ps-2.5 mb-5 text-xl font-bold text-blue-600">Digital Library</a>
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="/katalog" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 group">
                        <span class="ms-3">Book Catalog</span>
                    </a>
                </li>
                <li>
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li><a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">My Loans</a></li>
                        <li><a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">History</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <div class="p-6 bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="p-6 bg-amber-400 rounded-2xl shadow-lg shadow-amber-100">
                    <h5 class="text-amber-900 font-medium font-medium">New Member Queue</h5>
