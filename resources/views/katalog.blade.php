        ...
        <div x-show="showSearch" 
            ...
            <form action="/katalog" method="GET" class="max-w-md mx-auto relative">
                ...
                <input type="search" name="query" id="search" 
                       ...
                       value="{{ request('query') }}">
                <button type="submit" class="text-white absolute end-2 bottom-1.5 bg-red-950 hover:bg-red-900 font-medium rounded-xl text-xs px-4 py-1.5 transition-colors">
                    Cari
                </button>
            </form>
        </div>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-3xl shadow-2xl">
                <div class="flex items-center justify-between p-4 md:p-5 border-b border-stone-100">
                    ...
                    <button type="button" class="text-stone-400 bg-transparent hover:bg-red-50 hover:text-red-950 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-toggle="modal-pinjam">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
                <div class="flex justify-center md:justify-start">
                    <img src="{{ asset('images/readspace-library.png') }}" alt="Logo Readspace" class="h-24 w-auto object-contain">
                </div>
                <div>
                    <h6 class="font-bold mb-4 uppercase text-amber-200">Readspace Library</h6>
                    <p class="text-sm text-gray-300 leading-relaxed">
                        Platform perpustakaan digital untuk memudahkan mahasiswa Polibatam dalam meminjam buku fisik dan digital secara terintegrasi.
                    </p>
                </div>
                <div>
                    <h6 class="font-bold mb-4 uppercase text-amber-200">Politeknik Negeri Batam</h6>
                    <p class="text-sm text-gray-300">Jl. Ahmad Yani, Batam Kota, Kota Batam, Kepulauan Riau, Indonesia.</p>
                </div>
                <div>
